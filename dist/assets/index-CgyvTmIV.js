 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var X0;function YS(){return X0||(X0=1,(function(r){function e(P,B){var re=P.length;P.push(B);e:for(;0<re;){var me=re-1>>>1,ve=P[me];if(0<l(ve,B))P[me]=B,P[re]=ve,re=me;else break e}}function i(P){return P.length===0?null:P[0]}function s(P){if(P.length===0)return null;var B=P[0],re=P.pop();if(re!==B){P[0]=re;e:for(var me=0,ve=P.length,I=ve>>>1;me<I;){var K=2*(me+1)-1,Se=P[K],Te=K+1,De=P[Te];if(0>l(Se,re))Te<ve&&0>l(De,Se)?(P[me]=De,P[Te]=re,me=Te):(P[me]=Se,P[K]=re,me=K);else if(Te<ve&&0>l(De,re))P[me]=De,P[Te]=re,me=Te;else break e}}return B}function l(P,B){var re=P.sortIndex-B.sortIndex;return re!==0?re:P.id-B.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var d=Date,h=d.now();r.unstable_now=function(){return d.now()-h}}var m=[],p=[],v=1,S=null,g=3,M=!1,T=!1,D=!1,x=!1,y=typeof setTimeout=="function"?setTimeout:null,C=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function L(P){for(var B=i(p);B!==null;){if(B.callback===null)s(p);else if(B.startTime<=P)s(p),B.sortIndex=B.expirationTime,e(m,B);else break;B=i(p)}}function V(P){if(D=!1,L(P),!T)if(i(m)!==null)T=!0,O||(O=!0,Q());else{var B=i(p);B!==null&&W(V,B.startTime-P)}}var O=!1,z=-1,E=5,F=-1;function X(){return x?!0:!(r.unstable_now()-F<E)}function G(){if(x=!1,O){var P=r.unstable_now();F=P;var B=!0;try{e:{T=!1,D&&(D=!1,C(z),z=-1),M=!0;var re=g;try{t:{for(L(P),S=i(m);S!==null&&!(S.expirationTime>P&&X());){var me=S.callback;if(typeof me=="function"){S.callback=null,g=S.priorityLevel;var ve=me(S.expirationTime<=P);if(P=r.unstable_now(),typeof ve=="function"){S.callback=ve,L(P),B=!0;break t}S===i(m)&&s(m),L(P)}else s(m);S=i(m)}if(S!==null)B=!0;else{var I=i(p);I!==null&&W(V,I.startTime-P),B=!1}}break e}finally{S=null,g=re,M=!1}B=void 0}}finally{B?Q():O=!1}}}var Q;if(typeof U=="function")Q=function(){U(G)};else if(typeof MessageChannel<"u"){var ue=new MessageChannel,he=ue.port2;ue.port1.onmessage=G,Q=function(){he.postMessage(null)}}else Q=function(){y(G,0)};function W(P,B){z=y(function(){P(r.unstable_now())},B)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(P){P.callback=null},r.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<P?Math.floor(1e3/P):5},r.unstable_getCurrentPriorityLevel=function(){return g},r.unstable_next=function(P){switch(g){case 1:case 2:case 3:var B=3;break;default:B=g}var re=g;g=B;try{return P()}finally{g=re}},r.unstable_requestPaint=function(){x=!0},r.unstable_runWithPriority=function(P,B){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var re=g;g=P;try{return B()}finally{g=re}},r.unstable_scheduleCallback=function(P,B,re){var me=r.unstable_now();switch(typeof re=="object"&&re!==null?(re=re.delay,re=typeof re=="number"&&0<re?me+re:me):re=me,P){case 1:var ve=-1;break;case 2:ve=250;break;case 5:ve=1073741823;break;case 4:ve=1e4;break;default:ve=5e3}return ve=re+ve,P={id:v++,callback:B,priorityLevel:P,startTime:re,expirationTime:ve,sortIndex:-1},re>me?(P.sortIndex=re,e(p,P),i(m)===null&&P===i(p)&&(D?(C(z),z=-1):D=!0,W(V,re-me))):(P.sortIndex=ve,e(m,P),T||M||(T=!0,O||(O=!0,Q()))),P},r.unstable_shouldYield=X,r.unstable_wrapCallback=function(P){var B=g;return function(){var re=g;g=B;try{return P.apply(this,arguments)}finally{g=re}}}})(hd)),hd}var W0;function ZS(){return W0||(W0=1,dd.exports=YS()),dd.exports}var pd={exports:{}},Ln={};/**
 * @license React
...
void main() {
	...
	`}class I_ extends Qn{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const s={width:e,height:e,depth:1},l=[s,s,s,s,s,s];this.texture=new R_(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new el(5,5,5),c=new Fn({name:"CubemapFromEquirect",uniforms:zr(s.uniforms),vertexShader:s.vertexShader,fragmentShader:s.fragmentShader,side:Kn,blending:Wi});c.uniforms.tEquirect.value=i;const d=new Zn(l,c),h=i.minFilter;return i.minFilter===Us&&(i.minFilter=In),new bM(1,10,this).update(e,d),i.minFilter=h,d.geometry.dispose(),d.material.dispose(),this}clear(e,i=!0,s=!0,l=!0){const c=e.getRenderTarget();for(let d=0;d<6;d++)e.setRenderTarget(this,d),e.clear(i,s,l);e.setRenderTarget(c)}}function y1(r){let e=new WeakMap,i=new WeakMap,s=null;function l(g,M=!1){return g==null?null:M?d(g):c(g)}function c(g){if(g&&g.isTexture){const M=g.mapping;if(M===vd||M===_d)if(e.has(g)){const T=e.get(g).texture;return h(T,g.mapping)}else{const T=g.image;if(T&&T.height>0){const D=new I_(T.height);return D.fromEquirectangularTexture(r,g),e.set(g,D),g.addEventListener("dispose",p),h(D.texture,g.mapping)}else return null}}return g}function d(g){if(g&&g.isTexture){const M=g.mapping,T=M===vd||M===_d,D=M===Ps||M===Ir;if(T||D){let x=i.get(g);const y=x!==void 0?x.texture.pmremVersion:0;if(g.isRenderTargetTexture&&g.pmremVersion!==y)return s===null&&(s=new Uv(r)),x=T?s.fromEquirectangular(g,x):s.fromCubemap(g,x),x.texture.pmremVersion=g.pmremVersion,i.set(g,x),x.texture;if(x!==void 0)return x.texture;{const C=g.image;return T&&C&&C.height>0||D&&C&&m(C)?(s===null&&(s=new Uv(r)),x=T?s.fromEquirectangular(g):s.fromCubemap(g),x.texture.pmremVersion=g.pmremVersion,i.set(g,x),g.addEventListener("dispose",v),x.texture):null}}}return g}function h(g,M){return M===vd?g.mapping=Ps:M===_d&&(g.mapping=Ir),g}function m(g){let M=0;const T=6;for(let D=0;D<T;D++)g[D]!==void 0&&M++;return M===T}function p(g){const M=g.target;M.removeEventListener("dispose",p);const T=e.get(M);T!==void 0&&(e.delete(M),T.dispose())}function v(g){const M=g.target;M.removeEventListener("dispose",v);const T=i.get(M);T!==void 0&&(i.delete(M),T.dispose())}function S(){e=new WeakMap,i=new WeakMap,s!==null&&(s.dispose(),s=null)}return{get:l,dispose:S}}function M1(r){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=r.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&Bh("WebGLRenderer: "+s+" extension not supported."),l}}}function b1(r,e,i,s){const l={},c=new WeakMap;function d(S){const g=S.target;g.index!==null&&e.remove(g.index);for(const T in g.attributes)e.remove(g.attributes[T]);g.removeEventListener("dispose",d),delete l[g.id];const M=c.get(g);M&&(e.remove(M),c.delete(g)),s.releaseStatesOfGeometry(g),g.isInstancedBufferGeometry===!0&&delete g._maxInstanceCount,i.memory.geometries--}function h(S,g){return l[g.id]===!0||(g.addEventListener("dispose",d),l[g.id]=!0,i.memory.geometries++),g}function m(S){const g=S.attributes;for(const M in g)e.update(g[M],r.ARRAY_BUFFER)}function p(S){const g=[],M=S.index,T=S.attributes.position;let D=0;if(T===void 0)return;if(M!==null){const C=M.array;D=M.version;for(let U=0,L=C.length;U<L;U+=3){const V=C[U+0],O=C[U+1],z=C[U+2];g.push(V,O,O,z,z,V)}}else{const C=T.array;D=T.version;for(let U=0,L=C.length/3-1;U<L;U+=3){const V=U+0,O=U+1,z=U+2;g.push(V,O,O,z,z,V)}}const x=new(T.count>=65535?A_:T_)(g,1);x.version=D;const y=c.get(S);y&&e.remove(y),c.set(S,x)}function v(S){const g=c.get(S);if(g){const M=S.index;M!==null&&g.version<M.version&&p(S)}else p(S);return c.get(S)}return{get:h,update:m,getWireframeAttribute:v}}function E1(r,e,i){let s;function l(S){s=S}let c,d;function h(S){c=S.type,d=S.bytesPerElement}function m(S,g){r.drawElements(s,g,c,S*d),i.update(g,s,1)}function p(S,g,M){M!==0&&(r.drawElementsInstanced(s,g,c,S*d,M),i.update(g,s,M))}function v(S,g,M){if(M===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,g,0,c,S,0,M);let D=0;for(let x=0;x<M;x++)D+=g[x];i.update(D,s,1)}this.setMode=l,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=v}function T1(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,d,h){switch(i.calls++,d){case r.TRIANGLES:i.triangles+=h*(c/3);break;case r.LINES:i.lines+=h*(c/2);break;case r.LINE_STRIP:i.lines+=h*(c-1);break;case r.LINE_LOOP:i.lines+=h*c;break;case r.POINTS:i.points+=h*c;break;default:At("WebGLInfo: Unknown draw mode:",d);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function A1(r,e,i){const s=new WeakMap,l=new sn;function c(d,h,m){const p=d.morphTargetInfluences,v=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,S=v!==void 0?v.length:0;let g=s.get(h);if(g===void 0||g.count!==S){let X=function(){E.dispose(),s.delete(h),h.removeEventListener("dispose",X)};var M=X;g!==void 0&&g.texture.dispose();const T=h.morphAttributes.position!==void 0,D=h.morphAttributes.normal!==void 0,x=h.morphAttributes.color!==void 0,y=h.morphAttributes.position||[],C=h.morphAttributes.normal||[],U=h.morphAttributes.color||[];let L=0;T===!0&&(L=1),D===!0&&(L=2),x===!0&&(L=3);let V=h.attributes.position.count*L,O=1;V>e.maxTextureSize&&(O=Math.ceil(V/e.maxTextureSize),V=e.maxTextureSize);const z=new Float32Array(V*O*4*S),E=new M_(z,V,O,S);E.type=ji,E.needsUpdate=!0;const F=L*4;for(let G=0;G<S;G++){const Q=y[G],ue=C[G],he=U[G],W=V*O*4*G;for(let P=0;P<Q.count;P++){const B=P*F;T===!0&&(l.fromBufferAttribute(Q,P),z[W+B+0]=l.x,z[W+B+1]=l.y,z[W+B+2]=l.z,z[W+B+3]=0),D===!0&&(l.fromBufferAttribute(ue,P),z[W+B+4]=l.x,z[W+B+5]=l.y,z[W+B+6]=l.z,z[W+B+7]=0),x===!0&&(l.fromBufferAttribute(he,P),z[W+B+8]=l.x,z[W+B+9]=l.y,z[W+B+10]=l.z,z[W+B+11]=he.itemSize===4?l.w:1)}}g={count:S,texture:E,size:new rt(V,O)},s.set(h,g),h.addEventListener("dispose",X)}if(d.isInstancedMesh===!0&&d.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",d.morphTexture,i);else{let T=0;for(let x=0;x<p.length;x++)T+=p[x];const D=h.morphTargetsRelative?1:1-T;m.getUniforms().setValue(r,"morphTargetBaseInfluence",D),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",g.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",g.size)}return{update:c}}function C1(r,e,i,s,l){let c=new WeakMap;function d(p){const v=l.render.frame,S=p.geometry,g=e.get(p,S);if(c.get(g)!==v&&(e.update(g),c.set(g,v)),p.isInstancedMesh&&(p.hasEventListener("dispose",m)===!1&&p.addEventListener("dispose",m),c.get(p)!==v&&(i.update(p.instanceMatrix,r.ARRAY_BUFFER),p.instanceColor!==null&&i.update(p.instanceColor,r.ARRAY_BUFFER),c.set(p,v))),p.isSkinnedMesh){const M=p.skeleton;c.get(M)!==v&&(M.update(),c.set(M,v))}return g}function h(){c=new WeakMap}function m(p){const v=p.target;v.removeEventListener("dispose",m),s.releaseStatesOfObject(v),i.remove(v.instanceMatrix),v.instanceColor!==null&&i.remove(v.instanceColor)}return{update:d,dispose:h}}const w1={[r_]:"LINEAR_TONE_MAPPING",[o_]:"REINHARD_TONE_MAPPING",[l_]:"CINEON_TONE_MAPPING",[c_]:"ACES_FILMIC_TONE_MAPPING",[f_]:"AGX_TONE_MAPPING",[d_]:"NEUTRAL_TONE_MAPPING",[u_]:"CUSTOM_TONE_MAPPING"};function R1(r,e,i,s,l){const c=new Qn(e,i,{type:r,depthBuffer:s,stencilBuffer:l,depthTexture:s?new Fr(e,i):void 0}),d=new Qn(e,i,{type:hi,depthBuffer:!1,stencilBuffer:!1}),h=new Jn;h.setAttribute("position",new Dn([-1,3,0,-1,-1,0,3,-1,0],3)),h.setAttribute("uv",new Dn([0,2,0,0,2,0],2));const m=new vM({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter(qo).join(`
`)),d=kh(d),d=Xv(d,i),d=Wv(d,i),h=kh(h),h=Xv(h,i),h=Wv(h,i),d=qv(d),h=qv(h),i.isRawShaderMaterial!==!0&&(C=`#version 300 es
...
`)+`
`+y);const U=C+x+d,L=C+y+h,V=Vv(l,l.VERTEX_SHADER,U),O=Vv(l,l.FRAGMENT_SHADER,L);l.attachShader(D,V),l.attachShader(D,O),i.index0AttributeName!==void 0?l.bindAttribLocation(D,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(D,0,"position"),l.linkProgram(D);function z(G){if(r.debug.checkShaderErrors){const Q=l.getProgramInfoLog(D)||"",ue=l.getShaderInfoLog(V)||"",he=l.getShaderInfoLog(O)||"",W=Q.trim(),P=ue.trim(),B=he.trim();let re=!0,me=!0;if(l.getProgramParameter(D,l.LINK_STATUS)===!1)if(re=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,D,V,O);else{const ve=jv(l,V,"vertex"),I=jv(l,O,"fragment");At("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(D,l.VALIDATE_STATUS)+`
